        ...
        <div className="ck-modal-overlay">
            <div className="ck-checkout-modal">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="ck-customer-info-section">
                        <h3>Customer Information</h3>
                        {checkoutType === 'online' && (
                            <>
                                {addresses.length > 0 && !editingAddress && (
                                    <div className="ck-address-selector-container">
                                ...
                                {!editingAddress && currentAddress && (
                                    <div className="ck-fixed-info">
                                        ...
                                        <button type="button" className="ck-edit-button" onClick={() => setEditingAddress(true)}>
                                            Edit
                                        </button>
                                        <button
                                            type="button"
                                            className="ck-delete-button"
                                ...
                                {editingAddress && (
                                    <div className="ck-delivery-form">
                                        <FormInput
                                            label="Full Name *"
                                        ...
                                        />
                                        <button type="button" className="ck-apply-address-btn" onClick={handleApplyAddress}>
                                            Save Address
                                        </button>
                                    </div>
                                )}
                                {addresses.length > 0 && (
                                    <button type="button" className="ck-add-address-btn" onClick={handleAddNewAddress}>
                                        + Add New Address
                                    </button>
                                )}
                            </>
                        ...
                        <div className="ck-form-group">
                            ...
                            {checkoutType === 'online' ? (
                                ...
                                <div className="ck-payment-options-radio">
                                    {['Cash', 'GCash'].map((opt) => (
                                        <label key={opt}>
                                            <input
                                                type="radio"
                    ...
                    <div className="ck-modal-total">
                        <strong>Total: ₱{finalTotal.toFixed(2)}</strong>
                    </div>
                    <button type="submit" className="ck-submit-order-btn">
