...
const DB_CONFIG = {
    ...
    database: process.env.DB_NAME || "customer_auth_db",
};
...
db.getConnection()
    .then(() => console.log(" Customer Auth Service: MySQL connected"))
...
// ──────────────────────────────────────────────────
// NEW: Endpoint to get Customer Name and Email for Order Service (THE FIX)
// ──────────────────────────────────────────────────
...
// --------------------------------------------------
app.listen(5004, () => {
    console.log("Customer Auth Service running on port 5004");
});