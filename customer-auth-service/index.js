...
// 2. Create connection pool using the full URL string
...
app.post("/register", async (req, res) => {
    ...
    try {
        ...
        // Insert the new gmail column and value
        await db.execute(
